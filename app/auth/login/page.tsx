    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <button
            onClick={mode === 'login' ? handleEmailLogin : mode === 'signup' ? handleEmailSignup : handlePasswordReset}
            disabled={loading}
          ...
          >
            {loading ? 'Chargement...' : mode === 'login' ? 'Se connecter' : mode === 'signup' ? 'Créer mon compte' : 'Envoyer le lien de réinitialisation'}
          </button>
